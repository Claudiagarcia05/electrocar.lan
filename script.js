...
window.cambiarIdioma = function() {
    ...
    cargarTraducciones().then(() => {
        // Forzar actualización de la vista Vue
...
function actualizarIdiomaUI() {
    ...
    const idiomaActualElement = document.getElementById('idioma-actual');
    
    if (idiomaTexto) {
        idiomaTexto.textContent = idiomaActual.toUpperCase();
    }
    
    if (idiomaActualElement) {
        idiomaActualElement.lang = idiomaActual;
    }
}
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    // Asegurar que cargarTraducciones esté disponible globalmente
